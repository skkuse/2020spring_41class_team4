{/* <script> */}
var course_list = document.getElementById('course_value');
...
$(function() {
	...
	ScheduleTemplate.prototype.openModal = function(target) {
		...
		this.modalEventName.textContent = "haha";//target.getElementsByTagName('em')[0].textContent;
	...
	ScheduleTemplate.prototype.loadEventContent = function(content) {
		...
		httpRequest.open('GET', '/rest/courses/'+content );
    httpRequest.send();
	};
